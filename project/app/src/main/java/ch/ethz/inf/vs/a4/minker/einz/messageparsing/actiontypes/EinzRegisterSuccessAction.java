...
public class EinzRegisterSuccessAction extends EinzAction {
    /**
     * @param sInterface
     * @param serverManager
     ...
     */
    public EinzRegisterSuccessAction(ServerFunctionDefinition sInterface, EinzServerManager serverManager, EinzMessage params, String issuedByPlayer, EinzServerClientHandler issuedByClientHandler) {
