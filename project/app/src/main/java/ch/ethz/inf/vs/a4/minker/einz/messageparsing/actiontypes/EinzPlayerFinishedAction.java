...
public class EinzPlayerFinishedAction extends EinzAction {
     ...
     */
    public EinzPlayerFinishedAction(ServerFunctionDefinition sInterface, EinzServerManager serverManager, EinzMessage params, String issuedByPlayer, EinzServerClientHandler issuedByClientHandler) {
     ...
     */
    public EinzPlayerFinishedAction(ServerFunctionDefinition sInterface, EinzServerManager serverManager, EinzMessage params, String issuedByPlayer, EinzServerClientHandler issuedByClientHandler, ClientActionCallbackInterface clientActionCallbackInterface, Object completelyCustom){
    ...
    @Override
    public void run() {
        getClientActionCallbackInterface().onPlayerFinished(getMessage());
    }
}
