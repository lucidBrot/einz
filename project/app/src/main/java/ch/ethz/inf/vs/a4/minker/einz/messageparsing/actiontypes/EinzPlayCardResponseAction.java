...
public class EinzPlayCardResponseAction extends EinzAction {
     ...
     */
    public EinzPlayCardResponseAction(ServerFunctionDefinition sInterface, EinzServerManager serverManager, EinzMessage params, String issuedByPlayer, EinzServerClientHandler issuedByClientHandler) {
     ...
     */
    public EinzPlayCardResponseAction(ServerFunctionDefinition sInterface, EinzServerManager serverManager, EinzMessage params, String issuedByPlayer, EinzServerClientHandler issuedByClientHandler, ClientActionCallbackInterface clientActionCallbackInterface, Object completelyCustom){
    ...
    @Override
    public void run() {
        getClientActionCallbackInterface().onPlayCardResponse(getMessage());
    }
}
